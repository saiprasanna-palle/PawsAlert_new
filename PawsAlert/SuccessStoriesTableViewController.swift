...
class SuccessStoriesTableViewController: UITableViewController {
    ...
    var successStoryData = ["The Puppy was saved successfully and was treated for wounds","The Kitten has finally found it's master"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.volunteerImage.image = UIImage(named: "bg4.jpg")
        cell.petImage.image = UIImage(named: "bg2.jpg")
        cell.successStory.text = successStoryData[indexPath.row]
        // Configure the cell...
